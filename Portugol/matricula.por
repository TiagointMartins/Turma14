programa
{
		...
		se(escolher == 1)
	{
			para(inteiro i = 0; i<39; i++)
		{
			...
			{
				escreva("\n Sexo ",sexos[i],  " , Nota: ", notas[i], " MATRICULA: ",matricula[i], " Aprovado  Nome Aluno: ", alunos[i], "\n")
			}
			senao se(sexos[i] == 'M' e notas[i] < 5)
			{
				escreva("\n Sexo ",sexos[i],  " , Nota: ", notas[i], " MATRICULA: ",matricula[i]," Reprovado  Nome Aluno: ", alunos[i], "\n")
			}
		...
		senao se(escolher == 2)
		{
			para(inteiro i = 0; i<39;i++)
			{
				...
				{
						escreva("\n Sexo ",sexos[i],  " , Nota: ", notas[i], " MATRICULA: ",matricula[i], " Aprvada  Nome Aluna: ", alunos[i], "\n")
				}
				senao se(sexos[i] == 'F' e notas[i] < 5)
				{
						escreva("\n Sexo ",sexos[i],  " , Nota: ", notas[i], " MATRICULA: ",matricula[i], " Reprovada  Nome Aluna: ", alunos[i], "\n")
		...
		senao se(escolher == 3)
	{
			para(inteiro i=0 ; i<39 ; i++)
		{
		 	...
		 	{
		 	escreva("\n Sexo ",sexos[i],  " , Nota: ", notas[i], " MATRICULA: ",matricula[i]," APROVADO  Nome Aluna: ", alunos[i], "\n")
		 	}
		 	senao se(notas[i] > 5 e sexos[i] == 'F') 
		 	{
		 	escreva("\n Sexo ",sexos[i],  " , Nota: ", notas[i], " MATRICULA: ",matricula[i]," APROVADA  Nome Aluna: ", alunos[i], "\n")
		 	}
		 }
			...
			para(inteiro i = 0; i<39; i++)
		{
			...
			se(sexos[i] == 'M' e notas[i] <= 5)
			{
			escreva("\n Nome Aluno: ", alunos[i], "/ sexo - ", sexos[i] , " , Nota: ", notas[i], " - Reprovado\n")	
			}
			senao se (sexos[i] == 'F' e notas[i] <= 5)
			escreva("\n Nome Aluno: ", alunos[i], "/ sexo - ", sexos[i] , " , Nota: ", notas[i], " - Reprovada\n")
		}
		...
		senao se(escolher == 5)
		{
			...
			se(notaAluno == 1)
			{
				para(inteiro i=0; i<39; i++)
				{
					...
					{
						escreva("\n - Nome Aluno: ", alunos[i], "/ sexo - ", sexos[i], " MATRICULA: ",matricula[i]," , Nota: ", notas[i])
					}
					se(notas[i] > notaBase e sexos[i]=='F')
					{
						escreva("\n - Nome Aluna: ", alunos[i], "/ sexo - ", sexos[i], " MATRICULA: ",matricula[i], " , Nota: ", notas[i])
					}
